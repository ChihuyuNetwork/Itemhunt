...
object TargetItem {
    ...
    val targetData = hashMapOf(
        ...
        TargetCategory.ORE_NORMAL to mapOf(
            Material.RAW_COPPER to 5,
            Material.REDSTONE to 12,
            Material.DIAMOND to 30,
            Material.EMERALD to 50,
            Material.LAPIS_LAZULI to 10,
            Material.AMETHYST_SHARD to 40,
            Material.RAW_IRON to 10,
            Material.COAL to 6,
